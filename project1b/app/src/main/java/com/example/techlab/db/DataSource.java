...
public class DataSource {
        ...
        public Cursor selectAllUsers() {
                Cursor cursor = mDatabase.query(mTechLabDataBaseHelper.USER_TABLE_NAME,
                                new String[] { mTechLabDataBaseHelper.COLUMN_SCHOOLEMAIL,
                                                mTechLabDataBaseHelper.COLUMN_FIRSTNAME,
                                                mTechLabDataBaseHelper.COLUMN_LOANED_AMOUNT },
                                null, null, null, null, null);
                return cursor;
        }

        public Cursor selectAllproduct() {
                Cursor cursor = mDatabase.query(mTechLabDataBaseHelper.ELECTRONICS_TABLE_NAME, new String[] {
                                mTechLabDataBaseHelper.COLUMN_ELECTRONICS_ID,
                                mTechLabDataBaseHelper.COLUMN_ELECTRONICS_MANUFACTURER,
                                mTechLabDataBaseHelper.COLUMN_PRODUCT_NAME, mTechLabDataBaseHelper.COLUMN_STOCK,
                                mTechLabDataBaseHelper.COLUMN_AMOUNT_BROKEN, mTechLabDataBaseHelper.COLUMN_CATEGORY,
                                mTechLabDataBaseHelper.COLUMN_DESCRIPTION, mTechLabDataBaseHelper.COLUMN_IMAGE_DATA },
                                null, null, null, null, null);
                return cursor;
        }
        ...
        public Cursor selectUsersWithLoanedProduct() {
                ...
                Cursor cursor = (Cursor) mDatabase.query(mTechLabDataBaseHelper.USER_TABLE_NAME,
                                new String[] { mTechLabDataBaseHelper.COLUMN_SURNAME }, whereClause, null, null, null,
                                null
        ...
        public void updateUser(Users user) {
                String whereClause = mTechLabDataBaseHelper.COLUMN_SCHOOLEMAIL + " = " + user.getSchoolEmail();
                ...
                values.put(mTechLabDataBaseHelper.COLUMN_PASSWORD, user.getPassword());
                values.put(mTechLabDataBaseHelper.COLUMN_LOANED_AMOUNT, user.getLoanedAmount());
                mDatabase.update(mTechLabDataBaseHelper.USER_TABLE_NAME, values, whereClause, null);
        }

        public void updateElectronic(Electronics electronic, String id) {

                String whereClause = mTechLabDataBaseHelper.COLUMN_ID + " = " + id;
                ...
                mDatabase.update(mTechLabDataBaseHelper.ELECTRONICS_TABLE_NAME, values, whereClause, null);
        }

        // Delete
        public void deleteUser(Users user) {
                String whereClause = mTechLabDataBaseHelper.COLUMN_SCHOOLEMAIL + " = " + user.getSchoolEmail();
                mDatabase.delete(mTechLabDataBaseHelper.USER_TABLE_NAME, whereClause, null);
        }

        public void deleteProduct(String id) {
                String whereClause = mTechLabDataBaseHelper.COLUMN_ID + " = " + id;
                mDatabase.delete(mTechLabDataBaseHelper.ELECTRONICS_TABLE_NAME, whereClause, null);
        }
